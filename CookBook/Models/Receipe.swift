...
struct Receipe: Identifiable, Codable {
    ...
    init(id: String, ownerID: String, name: String, image: String, instructions: String, time: Int) {
        self.id = id
